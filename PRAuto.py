...
class AuditProcessor:
    ...
    def process_audit(self, output_path):
        ...
        with pd.ExcelWriter(output_path, engine='openpyxl') as writer:
            for idx, (nome_aba, filtro) in enumerate(procedimentos.items()):
                # - Filtragem direta para economizar memória
    ...
    def aplicar_estilo(self, writer, nome_aba, num_cols_clientes, tem_filtro):
        ...
        # - Cabeçalhos Fixos
        ws['A1'] = "Villela e Associados Auditoria e Consultoria Ltda."; ws['A1'].font = Font(size=14, bold=True)
...
# --- Classes de Interface (Mantidas quase idênticas para não mudar sua experiência) ---
...
class App(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Auditoria Digital - Villela e Associados")
